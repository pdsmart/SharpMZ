...
# Adapted and enhanced for the Alliance Memory AS4C16M16SA SDRAM by Philip Smart
# Apr 2020.
# ------------------------------------------------------------------------------
...
# your board.
# -----------------------------------------------------------------
set sysclk_pll "IOPCLK|altpll_component|auto_generated|generic_pll1~PLL_OUTPUT_COUNTER|divclk"
set memclk_pll "IOPCLK|altpll_component|auto_generated|generic_pll2~PLL_OUTPUT_COUNTER|divclk"
